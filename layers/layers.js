...
var lyr_JalanInspeksi_5 = new ol.layer.Vector({
    ...
    <img src="styles/legend/JalanInspeksi_5_2.png" /> Jelek<br />\
    <img src="styles/legend/JalanInspeksi_5_3.png" /> Sedang<br />' });
...
var lyr_Saluran_6 = new ol.layer.Vector({
    ...
    <img src="styles/legend/Saluran_6_2.png" /> Jelek<br />\
    <img src="styles/legend/Saluran_6_3.png" /> Sedang<br />' });
...
var lyr_Saluran_9 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Saluran<br />\
    <img src="styles/legend/Saluran_9_0.png" /> Primer<br />\
    <img src="styles/legend/Saluran_9_1.png" /> Sekunder<br />' });
...
var layersList = [lyr_GoogleHybrid_0,lyr_OSMStandard_1,lyr_GoogleSatellite_2,lyr_LuasBaku_3,lyr_LuasFungsional_4,group_KondisiTahun2025,group_Aset];
...
lyr_JalanInspeksi_5.set('fieldAliases', {'nama': 'Nama', 'nomenklatu': 'Nomenklatu', 'id_di': 'id_di', 'norec': 'norec', 'k_aset': 'k_aset', 'panjang': 'Panjang (50m)', 'kon_sal_25': 'Kondisi Saluran', 'kon_jln_25': 'Kondisi Jalan', 'jenis': 'Jenis', 'foto': 'Foto', 'stas_awal': 'stas_awal', 'stas_akhir': 'stas_akhir', });
lyr_Saluran_6.set('fieldAliases', {'nama': 'Nama', 'nomenklatu': 'Nomenklatu', 'id_di': 'id_di', 'norec': 'norec', 'k_aset': 'k_aset', 'panjang': 'Panjang (50m)', 'kon_sal_25': 'Kondisi Saluran', 'kon_jln_25': 'Kondisi Jalan', 'jenis': 'Jenis', 'foto': 'Foto', 'stas_awal': 'Stasiun Awal', 'stas_akhir': 'Stasiun Akhir', });
lyr_Bangunan_7.set('fieldAliases', {'nama': 'Nama', 'nomenklatu': 'Nomenklatu', 'id_di': 'id_di', 'norec': 'norec', 'k_aset': 'k_aset', 'kon_25': 'Kondisi Bangunan', 'jenis': 'jenis', 'foto': 'foto', });
lyr_PetakTersier_8.set('fieldAliases', {'Nm_Inf': 'Nm_Inf', 'Luas_Ha': 'Luas_Ha', });
lyr_Saluran_9.set('fieldAliases', {'nomenklatu': 'nomenklatu', 'k_aset': 'k_aset', 'panjang': 'panjang', 'Jenis': 'Jenis', });
lyr_Bangunan_10.set('fieldAliases', {'nama': 'Nama', 'nomenklatu': 'Nomenklatu', 'id_di': 'id_di', 'norec': 'norec', 'k_aset': 'k_aset', 'kon_25': 'Kondisi Bangunan', 'jenis': 'jenis', 'foto': 'foto', });
...
lyr_JalanInspeksi_5.set('fieldImages', {'nama': 'TextEdit', 'nomenklatu': 'TextEdit', 'id_di': 'TextEdit', 'norec': 'TextEdit', 'k_aset': 'TextEdit', 'panjang': 'TextEdit', 'kon_sal_25': 'TextEdit', 'kon_jln_25': 'TextEdit', 'jenis': 'TextEdit', 'foto': 'ExternalResource', 'stas_awal': 'Hidden', 'stas_akhir': 'Hidden', });
lyr_Saluran_6.set('fieldImages', {'nama': 'TextEdit', 'nomenklatu': 'TextEdit', 'id_di': 'TextEdit', 'norec': 'TextEdit', 'k_aset': 'TextEdit', 'panjang': 'TextEdit', 'kon_sal_25': 'TextEdit', 'kon_jln_25': 'TextEdit', 'jenis': 'TextEdit', 'foto': 'ExternalResource', 'stas_awal': 'TextEdit', 'stas_akhir': 'TextEdit', });
lyr_Bangunan_7.set('fieldImages', {'nama': 'Hidden', 'nomenklatu': 'TextEdit', 'id_di': 'Hidden', 'norec': 'Hidden', 'k_aset': 'Hidden', 'kon_25': 'TextEdit', 'jenis': 'TextEdit', 'foto': 'ExternalResource', });
lyr_PetakTersier_8.set('fieldImages', {'Nm_Inf': 'TextEdit', 'Luas_Ha': 'TextEdit', });
lyr_Saluran_9.set('fieldImages', {'nomenklatu': 'TextEdit', 'k_aset': 'TextEdit', 'panjang': 'TextEdit', 'Jenis': 'TextEdit', });
lyr_Bangunan_10.set('fieldImages', {'nama': 'Hidden', 'nomenklatu': 'TextEdit', 'id_di': 'Hidden', 'norec': 'Hidden', 'k_aset': 'TextEdit', 'kon_25': 'TextEdit', 'jenis': 'TextEdit', 'foto': 'ExternalResource', });
...
lyr_JalanInspeksi_5.set('fieldLabels', {'nama': 'hidden field', 'nomenklatu': 'inline label - visible with data', 'id_di': 'hidden field', 'norec': 'hidden field', 'k_aset': 'hidden field', 'panjang': 'inline label - visible with data', 'kon_sal_25': 'inline label - visible with data', 'kon_jln_25': 'inline label - visible with data', 'jenis': 'inline label - visible with data', 'foto': 'no label', });
lyr_Saluran_6.set('fieldLabels', {'nama': 'hidden field', 'nomenklatu': 'inline label - visible with data', 'id_di': 'hidden field', 'norec': 'hidden field', 'k_aset': 'hidden field', 'panjang': 'inline label - visible with data', 'kon_sal_25': 'inline label - visible with data', 'kon_jln_25': 'inline label - visible with data', 'jenis': 'inline label - visible with data', 'foto': 'no label', 'stas_awal': 'inline label - visible with data', 'stas_akhir': 'inline label - visible with data', });
lyr_Bangunan_7.set('fieldLabels', {'nomenklatu': 'inline label - visible with data', 'kon_25': 'inline label - visible with data', 'jenis': 'inline label - visible with data', 'foto': 'inline label - visible with data', });
lyr_PetakTersier_8.set('fieldLabels', {'Nm_Inf': 'hidden field', 'Luas_Ha': 'inline label - always visible', });
lyr_Saluran_9.set('fieldLabels', {'nomenklatu': 'inline label - visible with data', 'k_aset': 'hidden field', 'panjang': 'inline label - visible with data', 'Jenis': 'inline label - visible with data', });
lyr_Bangunan_10.set('fieldLabels', {'nomenklatu': 'inline label - visible with data', 'k_aset': 'hidden field', 'kon_25': 'inline label - visible with data', 'jenis': 'inline label - visible with data', 'foto': 'no label', });
