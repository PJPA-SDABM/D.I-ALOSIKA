...
var lyr_Saluran_7 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'Saluran<br />\
    <img src="styles/legend/Saluran_7_0.png" /> Saluran Primer<br />\
    <img src="styles/legend/Saluran_7_1.png" /> Saluran Sekunder<br />' });
...
lyr_LuasFungsional_2.set('fieldImages', {'OBJECTID': 'TextEdit', 'FID_Attrib': 'TextEdit', 'Id': 'TextEdit', 'FID_pusat1': 'TextEdit', 'Nm_Inf': 'TextEdit', 'Luas_Ha': 'TextEdit', 'Thn_Dat': 'TextEdit', 'Nama_WS': 'TextEdit', 'Nama_DAS': 'TextEdit', 'Irigasi': 'TextEdit', 'Jenis_DI': 'TextEdit', 'Bgn_UTM': 'TextEdit', 'Nm_Bgn_Utm': 'TextEdit', 'Smb_Air': 'TextEdit', 'Kewenangan': 'TextEdit', 'L_Renc': 'TextEdit', 'Luas_Pot': 'TextEdit', 'Luas_Fung': 'TextEdit', 'P_Sal_Ind': 'TextEdit', 'Ko_Sal_Ind': 'TextEdit', 'P_Sal_Sek': 'TextEdit', 'Ko_Sal_Sek': 'TextEdit', 'Pjn_Sal_Te': 'TextEdit', 'Kon_Sal_Te': 'TextEdit', 'P_Sal_Pem': 'TextEdit', 'Ko_Sal_Pe': 'TextEdit', 'P_Sal_Sup': 'TextEdit', 'Ko_Sal_Sup': 'TextEdit', 'Jml_Kl_Ps': 'TextEdit', 'Kon_Kl_Ps': 'TextEdit', 'Jml_Bg_Bag': 'TextEdit', 'Kon_Bg_Bag': 'TextEdit', 'Jml_Bg_B_S': 'TextEdit', 'Kon_Bg_B_S': 'TextEdit', 'Jml_Bg_Sad': 'TextEdit', 'Kon_Bg_Sad': 'TextEdit', 'Jml_Bg_Pen': 'TextEdit', 'Kon_Bg_Pen': 'TextEdit', 'Jml_Sip': 'TextEdit', 'Kon_Sip': 'TextEdit', 'Jml_Tlg': 'TextEdit', 'Kon_Tlg': 'TextEdit', 'Jml_Jmb': 'TextEdit', 'Kon_Jmb': 'TextEdit', 'Jml_plk': 'TextEdit', 'Kon_plk': 'TextEdit', 'Jml_P3A': 'TextEdit', 'Jml_A_GP3A': 'TextEdit', 'Jml_A_P3A': 'TextEdit', 'Koord_X': 'TextEdit', 'Koord_Y': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Nm_Prov': 'TextEdit', 'Nm_Kab': 'TextEdit', 'Kewenang_1': 'TextEdit', 'Nm_Inf_1': 'TextEdit', 'Nm_Prov_1': 'TextEdit', 'Keterangan': 'TextEdit', 'Shape_Le_1': 'TextEdit', 'Shape_Area': 'TextEdit', });
lyr_JalanInspeksi_3.set('fieldImages', {'nama': 'TextEdit', 'nomenklatu': 'TextEdit', 'id_di': 'TextEdit', 'norec': 'TextEdit', 'k_aset': 'TextEdit', 'panjang': 'TextEdit', 'kon_sal_25': 'TextEdit', 'kon_jln_25': 'TextEdit', 'jenis': 'TextEdit', 'foto': 'ExternalResource', 'stas_awal': 'TextEdit', 'stas_akhir': 'TextEdit', });
...
lyr_JalanInspeksi_3.set('fieldLabels', {'nama': 'hidden field', 'nomenklatu': 'inline label - visible with data', 'id_di': 'hidden field', 'norec': 'hidden field', 'k_aset': 'hidden field', 'panjang': 'inline label - visible with data', 'kon_sal_25': 'hidden field', 'kon_jln_25': 'inline label - visible with data', 'jenis': 'inline label - visible with data', 'foto': 'inline label - visible with data', 'stas_awal': 'inline label - visible with data', 'stas_akhir': 'inline label - visible with data', });
lyr_Saluran_4.set('fieldLabels', {'nama': 'hidden field', 'nomenklatu': 'inline label - visible with data', 'id_di': 'hidden field', 'norec': 'hidden field', 'k_aset': 'hidden field', 'panjang': 'inline label - visible with data', 'kon_sal_25': 'inline label - visible with data', 'kon_jln_25': 'hidden field', 'jenis': 'inline label - visible with data', 'foto': 'inline label - visible with data', 'stas_awal': 'inline label - visible with data', 'stas_akhir': 'inline label - visible with data', });
...
lyr_Bangunan_8.set('fieldLabels', {'nomenklatu': 'inline label - visible with data', 'k_aset': 'hidden field', 'kon_25': 'inline label - visible with data', 'jenis': 'inline label - visible with data', 'foto': 'inline label - visible with data', });
