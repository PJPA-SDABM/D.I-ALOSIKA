var size = 0;
var placement = 'point';
function categories_BangunanAlosika_5(feature, value, size, resolution, labelText,
...
var style_BangunanAlosika_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("kon_25");
    ...
    var style = categories_BangunanAlosika_5(feature, value, size, resolution, labelText,
